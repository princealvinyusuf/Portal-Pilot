...
<title>Bulk Deaktivasi SMS Notifikasi</title>
                ...
                <div class=<br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="smsNotificationResult">
                                ...
                                <button id="executePatchingBtn" class="btn btn-success" style="display: none;">Execute
                                    all patching
                                    process
                                    now</button>
                            </div>
                    ...
                    <script>
                        ...
                        function fileUploadProcess() {
                            ...
                            // Get the uploaded file data from the file input in the first section
                            var fileInput = document.getElementById('fileInput');
                            var file = fileInput.files[0];

                            // Process the file data as needed (for example, you can console log it here)
                            console.log('Refresh action triggered with file:', file);
